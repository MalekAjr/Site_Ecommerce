...
<body>
   ...
   <div class="container mt-5">
        <form method="POST">
            ...
            <input type="file" placeholder="image" class="form-control my-3 bg-dark text-white text-center" name="image">
            <textarea name="content" class="form-control my-3 bg-dark text-white" cols="30" rows="10"></textarea>
            <button class="btn btn-dark" name="new_post" value="Upload">Add Post</button>
        </form>
   </div>
